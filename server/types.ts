...
export interface LivenessResult {
  ...
  jitterPercent: number; // normal human speech: 0.2% - 1.5%
  shimmerPercent: number; // normal human speech: 1.0% - 4.0%
  hnrDb: number; // Harmonic-to-noise ratio: > 15 dB for human voice
  spectralFlatness: number; // synthetic vocoders often show unnaturally flat or banded high frequencies
  vocoderArtifactScore: number; // 0 to 1
  phaseContinuityScore: number; // 0 to 1
  isStudioProcessed?: boolean; // Detection of Auto-tune / compression as produced human voice
